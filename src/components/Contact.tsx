...
Portfolio Contact Form`;
    ...
    const mailtoLink = `mailto:ahmed.fikry.ghamry@gmail.com?subject=${encodeURIComponent(
      ...
      <div className="container mx-auto px-4 max-w-full overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="h-1 w-20 bg-emerald-400 mx-auto mb-6"></div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-emerald-400/10 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-8 p-4 sm:p-6 bg-zinc-800 rounded-lg border border-zinc-700">
                ...
                <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    ...
                    <span>.NET and C# Development</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 flex-shrink-0">▹</span>
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-6 w-full">
                ...
                <button
                  ...
                  className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-emerald-400 text-zinc-900 font-semibold rounded-lg hover:bg-emerald-300 transition-all duration-300 shadow-lg hover:shadow-emerald-400/50 flex items-center justify-center gap-2 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                >
